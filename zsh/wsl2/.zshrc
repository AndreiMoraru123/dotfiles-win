...
fpth+=${ZSH_CUSTOM:-${ZSH:-~/.oh-my-zsh}/custom}/plugins/zsh-completions/src
...
export TORCH_DIR="$LIBTORCH_DIR/share/cmake/Torch"

# Add LibTorch and CUDA paths to LD_LIBRARY_PATH and PATH
export LD_LIBRARY_PATH="$LIBTORCH_DIR/lib:$LD_LIBRARY_PATH"
export PATH="$LIBTORCH_DIR/bin:$PATH"
